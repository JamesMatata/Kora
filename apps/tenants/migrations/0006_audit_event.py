# Generated by Django 5.2.17 on 2026-09-10 05:52
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category', models.CharField(choices=[('PAYMENT', 'Payment'), ('ROLE', 'Role'), ('SETTINGS', 'Settings'), ('OTHER', 'Other')], default='OTHER', max_length=16)),
            ...
            options={
                'ordering': ['-created_at'],
                'indexes': [models.Index(fields=['school', 'category', 'created_at'], name='tenants_aud_school__ccb638_idx')],
            },
        ),
    ]
